...
if __name__ == '__main__':
    ...
    ASSET_UID = "aApe6MAjuXWHSVM36sj2Js"
    ...
    with open('./Abastecimiento.json', 'w') as file:
    ...
    try:
        ...
        if rawResult_fromProjects == [] or rawResult_fromProjects is None:
            ...
            for register in rawResult['results']:
                ...
                values = (str(project_id), str(data_id), str(id), str(instance), str(MainImageName), str(download_url))
        ...
        print(f"No projects found with ID: {ASSET_UID}")
